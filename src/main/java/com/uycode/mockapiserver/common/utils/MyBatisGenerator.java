...
public class MyBatisGenerator {
    ...
    //数据库连结信息
    private final String dbUrl = "jdbc:mysql://localhost:3306/mockdata?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=GMT";
    private final String driver = "com.mysql.cj.jdbc.Driver";
    private final String userName = "root";
    private final String password = "142857";

    //项目名
    private final String projectName = "mock-api-server";
    //指定包名
    private final String packageName = "com.uycode.mockapiserver";
    //controller基础类
...
//        int index = path.indexOf(projectName);
        return "D:/Users/Venux/IdeaProjects/" + projectName + "/src/main/java/";
    }
    /**
     * 策略配置
     * @param tableNames 表名
